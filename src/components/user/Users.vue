<template>
  <div>
    ...
    <el-dialog
      title="分配角色"
      :visible.sync="setRoleDiologVisible"
      width="50%" :ref="setRoleDiologRef"
      @close="setRoleDiologClose">
      <div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setRoleDiologVisible = false">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    async setRole (userInfo) {
      ...
      this.setRoleDiologVisible = true
    },
    // 点击确定按钮分配角色
    async saveRoleInfo () {
      ...
      this.getUserList()
      this.setRoleDiologVisible = false
    },
    // 分配角色对话框关闭事件
    setRoleDiologClose () {
      this.selectedRoleId = ''
